...
IC_conv(OCGT)        =           35080.5 /(8760/card(t))
;
IC_conv(CCGT)        =           40095.5 /(8760/card(t))
;
IC_conv(Biomass)     =           42095.5 /(8760/card(t))
;
IC_conv(oil)        =           5000000 /(8760/card(t))
;
IC_conv(coal)       =           51223 /(8760/card(t))
;
IC_conv(lig)        =           65193 /(8760/card(t))
;
IC_conv(nuc)        =           560200 /(8760/card(t)) 
;
IC_ren(wind_on)     =           93900 /(8760/card(t))
;
IC_ren(wind_off)    =           198171 /(8760/card(t))
;
IC_ren(solar_pv)    =           54555 /(8760/card(t))
;
