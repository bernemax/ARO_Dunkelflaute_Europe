...
*                                                                                                +  sum((ren)$Map_Ren_node(ren,n), PG_M_Ren(ren,t))
                                                                                                ...
                                                                                                -                        M_charge(psp,t))
*                                                                                                + sum((psp)$MapS(psp,n), PSP_operation(psp,t))
                                                                                                
%bat%                                                                                           + sum((b)$Map_battery(b,n), PG_M_battery(b,t)
%bat%                                                                                           -                       M_battery_charge(b,t))
*                                                                                                + sum((b)$Map_battery(b,n), Battery_operation(b,t))

%hydrogen%                                                                                      + sum((h)$Map_hydrogen(h,n),
%hydrogen%                                                                                                                PG_M_hydrogen(h,t)
%hydrogen%                                                                                      -                       M_hydrogen_charge(h,t))
*                                                                                                + sum((h)$Map_hydrogen(h,n),H2Stor_operation(h,t))

*%hydrogen%                                                                                      + sum(OCGT$Map_OCGT(OCGT,n), PG_M_hydrogen(OCGT,t))          
...
;
*Report_LS_costs = sum((t,n), LS_costs_1 * PLS_M_1.l(t,n) + LS_costs_2 * PLS_M_2.l(t,n) + LS_costs_3 * PLS_M_3.l(t,n)) 
*;
$ontext
Saldo_PSP(t) = sum(psp, PSP_operation.l(psp,t))
;
Gen_PSP(t) = Saldo_PSP(t)$(Saldo_PSP(t) gt 0)
;
Saldo_battery(t) = sum((b), Battery_operation.l(b,t))
;
Gen_battery(t) = Saldo_battery(t)$(Saldo_battery(t) gt 0)
;
Saldo_Hydrogen(t) = sum(h,  H2Stor_operation.l(h,t))
;
...
;
execute_unload "Result_New_Final_no_LS.gdx";
*eff_Benchmark_L100_LSstep