...
MP_ex_ntc_max_ex(n,nn,t,vv)$(ord(vv) lt (itaux+1))..                     power_flow_ex(n,nn,t,vv) =l= NTC_cap_ex(n,nn) +inv_NTC_M(n,nn)
;
*MP_ex_ntc_max_im(nn,n,t,vv)$(ord(vv) lt (itaux+1))..                     power_flow_ex(nn,n,t,vv) =l= NTC_cap_ex(nn,n)
*;
*MP_prosp_NTC_max_ex(n,nn,t,vv)$(ord(vv) lt (itaux+1))..                  power_flow_prosp(n,nn,t,vv) =l= inv_NTC_M(n,nn)
*;
...
$offtext                                                                
                                                                                ...
                                                                                + sum((n,nn), - phi_NTC_ex(n,nn) * NTC_cap_sub(n,nn))
...
;
*NTC_cap_sub(n,nn) = NTC_cap_ex(n,nn) + inv_NTC_M.l(n,nn)
*;
*NTC_cap_sub(nn,n) = NTC_cap_ex(nn,n) + inv_NTC_M.l(nn,n)
*;
